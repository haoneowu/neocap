...
const TEMPLATES: Template[] = [
	...
	},
	{
		...
		description: "NeoCap reads the text in your screenshot and copies it for you.",
	...
	return (
		<div class="cap-settings-page flex flex-col h-full custom-scroll">
			<SettingsPageContent>
				<Section
					title="Automations"
					description="Run actions automatically when something happens in NeoCap."
				>
					<Suspense
